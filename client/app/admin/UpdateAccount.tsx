...
const UpdateAccount = () => {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    toast.info('Image upload will be implemented when API is ready')
  }
  ...
  const onSubmit = async (values: z.infer<typeof UpdateAccountValidation>) => {
    ...
    try {
      ...
      toast.info('Account update will be implemented when API is ready')
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    toast.info('Image update will be implemented when API is ready')
  }
  return (
